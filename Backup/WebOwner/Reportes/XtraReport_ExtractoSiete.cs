...
{
    public partial class XtraReport_ExtractoSiete : DevExpress.XtraReports.UI.XtraReport
    {
        string[] meses = { "enero", "febrero", "marzo", "abril", "mayo", "junio", "julio", "agosto", "septiembre", "octubre", "noviembre", "diciembre"};

        public XtraReport_ExtractoSiete(string rutaPdf, DateTime fechaDesde, DateTime fechaHasta, int idHotel, int idPorcentajeSuit, 
                                   bool esAcumulado)
        {
            InitializeComponent();
        ...
        public XtraReport_ExtractoSiete(string rutaPdf, DateTime fechaDesde, DateTime fechaHasta, int idHotel, int idPorcentajeSuit, bool esAcumulado, ObjetoGenerico propietarioTmp)
        {
            InitializeComponent();
        ...
        public XtraReport_ExtractoSiete(int idpropietario, int idSuit, DateTime mesDesdeLiquidacion, DateTime mesHastaLiquidacion,
        ...
        public XtraReport_ExtractoSiete(string rutaPdf, DateTime fecha, int idHotel, int idPorcentajeSuit,
        ...
        private void ObtenerInfoLiquidacion(int idPropietario, int idHotel, int idSuite, DateTime fechaDesde, DateTime fechaHasta, bool esAcumulado)
        {
            ...
            foreach (Detalle_Extracto itemDetalle in extractoTmp.Detalle_Extracto)
            {
                ...
                switch (itemDetalle.IdControl)
                {
                    ...
                    case "ddlPorcentajeIngresoPropietario7":
                        lblTmp.Text = "INGRESO DEL PROPIETARIO A DISTRIBUIR";
                        break;

                    case "ddlCoeficiente":
                    case "ddlCoeficiente7":
                    case "ddlParticipacionPropietario7":
