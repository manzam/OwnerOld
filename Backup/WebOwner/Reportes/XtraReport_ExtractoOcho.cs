...
{
    public partial class XtraReport_ExtractoOcho : DevExpress.XtraReports.UI.XtraReport
    {
        string[] meses = { "enero", "febrero", "marzo", "abril", "mayo", "junio", "julio", "agosto", "septiembre", "octubre", "noviembre", "diciembre"};

        public XtraReport_ExtractoOcho(string rutaPdf, DateTime fechaDesde, DateTime fechaHasta, int idHotel, int idPorcentajeSuit, 
                                   bool esAcumulado)
        {
            InitializeComponent();
        ...
        public XtraReport_ExtractoOcho(string rutaPdf, DateTime fechaDesde, DateTime fechaHasta, int idHotel, int idPorcentajeSuit, bool esAcumulado, ObjetoGenerico propietarioTmp)
        {
            InitializeComponent();
        ...
        public XtraReport_ExtractoOcho(int idpropietario, int idSuit, DateTime mesDesdeLiquidacion, DateTime mesHastaLiquidacion,
        ...
        public XtraReport_ExtractoOcho(string rutaPdf, DateTime fecha, int idHotel, int idPorcentajeSuit,
                                  ...
                                  int idHotel, bool esAcumulado)
        {
            ...
            this.lblNit.Text = Utilities.FormatNit(propietarioTmp.Nit);
            ...
            this.lblNitPropietario.Text = (Utilities.FormatNit(propietarioTmp.NumIdentificacion)).Replace(",", ".");
        ...
        private void ObtenerInfoLiquidacion(int idPropietario, int idHotel, int idSuite, DateTime fechaDesde, DateTime fechaHasta, bool esAcumulado)
        {
            ...
            foreach (Detalle_Extracto itemDetalle in extractoTmp.Detalle_Extracto)
            {
                ...
                {
                    //case "ddlPorcentajeIngresoPropietario8":
                    //    lblTmp.Text = "INGRESO DEL PROPIETARIO (" + Math.Round((valor * 100), 3).ToString() + "%) A DISTRIBUIR";
                    //    break;

                    case "ddlCoeficiente8":
                    case "ddlParticipacionPropietario8":
                    ...
                    default:
                        lblTmp.Text = valor.ToString("N0").Replace(",", ".");
                        break;
                }
            }
        }
