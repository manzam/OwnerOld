...
{
    public partial class XtraReport_ExtractoSeis : DevExpress.XtraReports.UI.XtraReport
    {
        string[] meses = { "Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"};

        public XtraReport_ExtractoSeis(string rutaPdf, DateTime fechaDesde, DateTime fechaHasta, int idHotel, int idPorcentajeSuit, 
                                   bool esAcumulado)
        {
            InitializeComponent();
        ...
        public XtraReport_ExtractoSeis(string rutaPdf, DateTime fechaDesde, DateTime fechaHasta, int idHotel, int idPorcentajeSuit, bool esAcumulado, ObjetoGenerico propietarioTmp)
        {
            InitializeComponent();
        ...
        public XtraReport_ExtractoSeis(int idpropietario, int idSuit, DateTime mesDesdeLiquidacion, DateTime mesHastaLiquidacion,
        ...
        public XtraReport_ExtractoSeis(string rutaPdf, DateTime fecha, int idHotel, int idPorcentajeSuit,
                                  ...
                                  int idHotel, bool esAcumulado)
        {
            ...
            this.lblNitPropietario.Text = Utilities.FormatNit(propietarioTmp.NumIdentificacion);
        ...
        private void ObtenerInfoLiquidacion(int idPropietario, int idHotel, int idSuite, DateTime fechaDesde, DateTime fechaHasta, bool esAcumulado)
        {
            ...
            foreach (Detalle_Extracto itemDetalle in extractoTmp.Detalle_Extracto)
            {
                ...
                if (itemDetalle.IdControl == "ddlDesSegAnoS6" || itemDetalle.IdControl == "ddlDesSegAnoH6")
                { 
                }
                ...
                switch (itemDetalle.IdControl)
                {
                    ...
                    case "ddlCoeficiente":
                    case "ddlCoeficiente6":
                    case "ddlUtilidadOperacional6":
                    case "ddlParticipacionPropietario6":
