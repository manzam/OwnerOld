...
{
    public partial class XtraReport_ExtractoCinco : DevExpress.XtraReports.UI.XtraReport
    {
        string[] meses = { "Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"};

        public XtraReport_ExtractoCinco(string rutaPdf, DateTime fechaDesde, DateTime fechaHasta, int idHotel, int idPorcentajeSuit, 
                                   bool esAcumulado)
        {
            InitializeComponent();
        ...
        public XtraReport_ExtractoCinco(string rutaPdf, DateTime fechaDesde, DateTime fechaHasta, int idHotel, int idPorcentajeSuit, bool esAcumulado, ObjetoGenerico propietarioTmp)
        {
            InitializeComponent();
        ...
        public XtraReport_ExtractoCinco(int idpropietario, int idSuit, DateTime mesDesdeLiquidacion, DateTime mesHastaLiquidacion,
        ...
        public XtraReport_ExtractoCinco(string rutaPdf, DateTime fecha, int idHotel, int idPorcentajeSuit,
        ...
        private void ObtenerInfoLiquidacion(int idPropietario, int idHotel, int idSuite, DateTime fechaDesde, DateTime fechaHasta, bool esAcumulado)
        {
            ...
            foreach (Detalle_Extracto itemDetalle in extractoTmp.Detalle_Extracto)
            {
                ...
                {
                    if (itemDetalle.IdControl == "ddlPorcentajeIngresoPropietario5")
                ...
                switch (itemDetalle.IdControl)
                {
                    ...
                    case "ddlPorcentajeIngresoPropietario5":
                    ...
                    case "ddlParticipacionPropietario5":
                        lblTmp.Text = valor.ToString();
                        break;

                    case "ddlUtilidadOperacional5":
