<%@ Page Title="" Language="C#" MasterPageFile="~/templates/TemplatePrincipal.Master" AutoEventWireup="true" CodeBehind="ReporteReglas.aspx.cs" Inherits="WebOwner.ui.Paginas.ReporteReglas" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tr>
                    ...
                    <td style="width:80%;">
                        <asp:DropDownList ID="ddlReporte" AutoPostBack="true" runat="server" 
                            ...
                            <asp:ListItem Text="Variables" Value="tres" Selected="True"></asp:ListItem>
            ...
            <div class="tituloPrincipal">
                <h2>
                    <asp:Label ID="Label1" runat="server" Text="Variables"></asp:Label>
                </h2>
            </div> 
            ...
            <table width="100%">
                <tr>
                    ...
                    <td style="width:90%">
                        <asp:DropDownList ID="ddHotel" runat="server" Width="90%">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align:center;">
                        <asp:Button ID="btnAceptarTres" runat="server" Text="Aceptar" 
                            onclick="btnAceptarTres_Click" />
                    </td>
                </tr>
           </table>
