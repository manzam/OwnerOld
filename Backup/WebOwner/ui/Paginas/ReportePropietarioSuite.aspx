<%@ Page Title="" Language="C#" MasterPageFile="~/templates/TemplatePrincipal.Master" AutoEventWireup="true" CodeBehind="ReportePropietarioSuite.aspx.cs" Inherits="WebOwner.ui.Paginas.ReportePropietarioSuite" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tr>
                    ...
                    <td style="width:80%;">
                        <asp:DropDownList ID="ddlReporte" AutoPostBack="true" runat="server" 
                            ...
                            <asp:ListItem Text="Propietarios - Suite" Value="uno" Selected="True"></asp:ListItem>
            ...
            <div class="tituloPrincipal">
                <h2>
                    <asp:Label ID="Label1" runat="server" Text="Propietario - Suite"></asp:Label>
                </h2>
            </div> 
            ...
            <table width="100%">                    
                <tr>
                    <td class="textoTabla" style="width:10%;">Nombre</td>
                    <td>
                        <asp:TextBox ID="txtNombre" runat="server" Width="90%"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                <td class="textoTabla" style="width:10%;">N° Suite</td>
                    <td>
                        <asp:TextBox ID="txtNumSuite" runat="server" Width="10%"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="textoTabla" valign="top">Hotel</td>
                    <td>
                        <asp:DropDownList ID="ddlHotelPropietarios" runat="server" Width="90%">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td style="text-align:center;" colspan="2">
                        <asp:Button ID="btnAceptarUno" runat="server" Text="Aceptar" 
                            onclick="btnAceptarUno_Click" />
                    </td>
                </tr>
            </table>
