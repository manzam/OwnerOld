<%@ Page Title="" Language="C#" MasterPageFile="~/templates/TemplatePrincipal.Master" AutoEventWireup="true" CodeBehind="ReporteUsuario.aspx.cs" Inherits="WebOwner.ui.Paginas.ReporteUsuario" %>
        ...
        <ContentTemplate>
                ...
                <tr>
                    ...
                    <td style="width:80%;">
                        <asp:DropDownList ID="ddlReporte" AutoPostBack="true" runat="server" 
                            ...
                            <asp:ListItem Text="Usuarios" Value="cuatro" Selected="True"></asp:ListItem>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td style="width:90%">
                        <asp:DropDownList ID="ddlHotelUsuarios" runat="server" Width="90%">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align:center;">
                        <asp:Button ID="btnAceptarCuatro" runat="server" Text="Aceptar" 
                            onclick="btnAceptarCuatro_Click" />
                    </td>
                </tr>
           </table>
