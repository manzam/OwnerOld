<%@ Page Title="" Language="C#" MasterPageFile="~/templates/TemplatePrincipal.Master" AutoEventWireup="true" CodeBehind="ReporteConsolidadoPorPropietario.aspx.cs" Inherits="WebOwner.ui.Paginas.ReporteConsolidadoPorPropietario" %>
...
<script type="text/jscript" language="javascript">
    ...
    $j(document).ready(function() {
        ...
        function CargasIniciales(sender, args) {
            ...
            $j("#ctl00_Contenidoprincipal_txtFechaPropietario").spinner({
                min: 2000,
                max: y
            });
        }
        ...
        <ContentTemplate>
                ...
                <tr>
                    ...
                    <td style="width:80%;">
                        <asp:DropDownList ID="ddlReporte" AutoPostBack="true" runat="server" 
                            ...
                            <asp:ListItem Text="Consolidado por Propietario" Value="2" Selected="True"></asp:ListItem>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlPropietario" Width="90%" runat="server" 
                    ...
                    <td colspan="2">
                        <table width="50%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtFechaPropietario" Enabled="false" runat="server" Width="40px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </td>
