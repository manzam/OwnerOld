<%@ Page Title="" Language="C#" MasterPageFile="~/templates/TemplatePrincipal.Master" AutoEventWireup="true" CodeBehind="ReporteExtractoAcumulado.aspx.cs" Inherits="WebOwner.ui.Paginas.ReporteExtractoAcumulado" %>
...
<script type="text/jscript" language="javascript">
    ...
    $j(document).ready(function() {
        ...
        function CargasIniciales(sender, args) {
            ...
            $j("#ctl00_Contenidoprincipal_txtAnoInicio,#ctl00_Contenidoprincipal_txtAnoFin").spinner({
                min: 2000,
                max: y
            });
        }
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tr>
                    ...
                    <td style="width:80%;">
                        <asp:DropDownList ID="ddlReporte" AutoPostBack="true" runat="server" 
                            ...
                            <asp:ListItem Text="Extracto Consolidado" Value="EC" Selected="True"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
            </table>
            ...
            <div class="tituloPrincipal">
                <h2>
                    <asp:Label ID="Label1" runat="server" Text="Consolidado Propietario"></asp:Label>
                </h2>
            </div> 
            ...
            <table width="100%">
                <tr>
                    <td class="textoTabla" style="width:10%">Propietario</td>
                    <td>
                        <asp:DropDownList ID="ddlPropietario" Width="90%" runat="server" AutoPostBack="true" 
                            ValidationGroup="ConsolidadoPorSuite" 
                            onselectedindexchanged="ddlPropietario_SelectedIndexChanged">
                            <asp:ListItem Text="Seleccione..." Value="-1" Selected="True"></asp:ListItem>
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" 
                            ControlToValidate="ddlPropietario" InitialValue="-1" Display="Dynamic" CssClass="error" ValidationGroup="ConsolidadoPorPropietario" > 
                        </asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="textoTabla">Suite</td>
                    <td>
                        <asp:DropDownList ID="ddlSuite" Width="90%" runat="server">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <table width="50%">
                            <tr>
                                <td style="width:20%" class="textoTabla">Fecha Inicio</td>
                                <td style="text-align:center;">
                                    <asp:DropDownList ID="ddlMesInicioP" Width="110px" runat="server">
                                ...
                                <td>
                                    <asp:TextBox ID="txtAnoInicio" Enabled="false" runat="server" Width="40px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:20%" class="textoTabla">Fecha Fin</td>
                                <td style="text-align:center;">
                                    <asp:DropDownList ID="ddlMesFinP" Width="110px" runat="server">
                                        <asp:ListItem Value="1" Text="Enero" Selected="True"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="Febrero"></asp:ListItem>
                                        <asp:ListItem Value="3" Text="Marzo"></asp:ListItem>
                                        <asp:ListItem Value="4" Text="Abril"></asp:ListItem>
                                ...
                                <td>
                                    <asp:TextBox ID="txtAnoFin" Enabled="false" runat="server" Width="40px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td colspan="2" style="text-align:center;">
                        <asp:Button ID="btnConsolidadoPorPropietario" runat="server" Text="Aceptar" 
                            ValidationGroup="ConsolidadoPorPropietario" 
                            onclick="btnConsolidadoPorPropietario_Click" />
                    </td>
                </tr>
           </table>
