...
{
    public partial class XtraReport_ExtractoTres : DevExpress.XtraReports.UI.XtraReport
    {
        string[] meses = { "enero", "febrero", "marzo", "abril", "mayo", "junio", "Julio", "agosto", "septiembre", "octubre", "noviembre", "diciembre"};

        public XtraReport_ExtractoTres(string rutaPdf, DateTime fechaDesde, DateTime fechaHasta, int idHotel, int idPorcentajeSuit, 
        ...
        public XtraReport_ExtractoTres(string rutaPdf, DateTime fechaDesde, DateTime fechaHasta, int idHotel, int idPorcentajeSuit, bool esAcumulado, ObjetoGenerico propietarioTmp)
        {
            InitializeComponent();
        ...
        public XtraReport_ExtractoTres(int idpropietario, int idSuit, DateTime mesDesdeLiquidacion, DateTime mesHastaLiquidacion,
        ...
        public XtraReport_ExtractoTres(string rutaPdf, DateTime fecha, int idHotel, int idPorcentajeSuit,
                                  ...
                                  int idHotel, int idSuite, bool esAcumulado)
        {
            ...
            try
            {
                ...
                this.lblNitPropietario.Text = this.lblNitPropietario.Text.Replace(",", ".");
            }
            catch (Exception ex)
            {
        ...
        private void ObtenerInfoLiquidacion(int idPropietario, int idHotel, int idSuite, DateTime fechaDesde, DateTime fechaHasta, bool esAcumulado)
        {
            ...
            foreach (Detalle_Extracto itemDetalle in extractoTmp.Detalle_Extracto)
            {
                ...
                switch (itemDetalle.IdControl)
                {
                    ...
                    case "ddlCoeficiente":
                        lblTmp.Text = Math.Round((valor * 100), 4).ToString();
                        break;
                    ...
                    case "ddlParticipacionPropietario3":
                        lblTmp.Text = (valor * 100).ToString("N0") + "%";
                        break;                       

                    default:
                        lblTmp.Text = valor.ToString("N0");
                        lblTmp.Text = lblTmp.Text.Replace(",", ".");
                        break;
                }
            }
        }
