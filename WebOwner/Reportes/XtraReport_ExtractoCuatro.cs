...
{
    public partial class XtraReport_ExtractoCuatro : DevExpress.XtraReports.UI.XtraReport
    {
        string[] meses = { "Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"};

        public XtraReport_ExtractoCuatro(string rutaPdf, DateTime fechaDesde, DateTime fechaHasta, int idHotel, int idPorcentajeSuit, 
                                   bool esAcumulado)
        {
            InitializeComponent();
        ...
        public XtraReport_ExtractoCuatro(string rutaPdf, DateTime fechaDesde, DateTime fechaHasta, int idHotel, int idPorcentajeSuit, bool esAcumulado, ObjetoGenerico propietarioTmp)
        {
            InitializeComponent();
        ...
        public XtraReport_ExtractoCuatro(int idpropietario, int idSuit, DateTime mesDesdeLiquidacion, DateTime mesHastaLiquidacion,
                                   int idPorcentajeSuit, int idHotel, bool esAcumulado)
        {
            ...
            CrearExtracto(propietarioTmp, mesDesdeLiquidacion, mesHastaLiquidacion, idPorcentajeSuit, idHotel, idSuit, esAcumulado);
        }

        public XtraReport_ExtractoCuatro(string rutaPdf, DateTime fecha, int idHotel, int idPorcentajeSuit,
                                  ...
                                  int idHotel, int idSuite, bool esAcumulado)
        {
            ...
            this.lblNumCuenta.Text = string.Empty;// propietarioTmp.NumCuenta;
            this.lblNombreBanco.Text = string.Empty;//(propietarioTmp.NombreBanco == "SIN BANCO") ? string.Empty : propietarioTmp.NombreBanco;
            ...
            this.ObtenerInfoEstadistica(propietarioTmp.IdPropietario, idHotel, idSuite, fechaDesde, fechaHasta, esAcumulado);
        ...
        private void ObtenerInfoLiquidacion(int idPropietario, int idHotel, int idSuite, DateTime fechaDesde, DateTime fechaHasta, bool esAcumulado)
        {
            ...
            foreach (Detalle_Extracto itemDetalle in extractoTmp.Detalle_Extracto)
            {
                ...
                {
                    if (itemDetalle.IdControl == "ddlPorcentajeIngresoPropietario4")
                        lblTmp.Text = "INGRESO DEL PROPIETARIO %valor% A DISTRIBUIR".Replace("%valor%", "(" + (valor * 100).ToString("N0") + "%)");
                    else
                        lblTmp.Text = "0";
                ...
                switch (itemDetalle.IdControl)
                {
                    ...
                    case "ddlPorcentajeIngresoPropietario4":
                    ...
                    case "ddlParticipacionPropietario4":
                        lblTmp.Text = valor.ToString();
                        break;
